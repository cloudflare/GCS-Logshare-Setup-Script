...
if gcloud --version 2>&1 | grep "Updates are available for some Cloud SDK components." -c; then # Checking for Updates
    ...
    echo "GCloud SDK already installed. Skipping init configuration."
